...
//
// Pressing the friends button opens a bottom sheet (unfriend popup) with:
...
function LocationIcon() {
  return (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
      ...
      <path
        d="M18 13c-2.2 0-4 1.8-4 4 0 2.5 4 6 4 6s4-3.5 4-6c0-2.2-1.8-4-4-4z"
        stroke="white"
        strokeWidth="2"
        fill="none"
      />
...
export default function FriendProfilePage({
  ...
  // true = bottom sheet open

  const [showConfirm, setShowConfirm] = useState(false);
  // true = warning confirmation open
  ...
  return (
    <div className="friend-page">
      ...
      <main className="friend-main">
        ...
        <div className="friend-top">
          ...
          <div className="friend-info">
            ...
            {isFriend ? (
              // Already friends — opens bottom sheet
              <button
              ...
              // Not friends — pressing re-adds them
              <button
            ...
            {friendsList.map((f, i) => (
              <li key={f.id} className="friend-list-item">
                ...
                {i < friendsList.length - 1 && (
                  <div className="friend-list-divider" />
                )}
              </li>
            ))}
          </ul>
      ...
      {/* ── Warning popup after REMOVE FRIEND ── */}
      ...
      {/* ── Bottom sheet when pressing "friends" ── */}

      {showPopup && (
        <div
          className="unfriend-overlay"
          onClick={() => setShowPopup(false)}
        >
          <div
            className="unfriend-sheet"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="unfriend-header">
              {/* Shows only first name e.g. "LAURA" */}

              <span className="unfriend-name">
                {friend.name.split(" ")[0].toUpperCase()}
              </span>

              <button
                className="unfriend-close"
                onClick={() => setShowPopup(false)}
              >
                ✕
              </button>
