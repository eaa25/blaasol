...
// Overlapping profile photo circles showing which friends liked an act (max 2)
...
export default function SchedulePage({ likedArtists, onToggleLike, onGroupClick, onMenuClick, onProfileClick }) {
  ...
  return (
    <div className="schedule-page">
        ...
        {ACTS.map((act) => {
          ...
          return (
            <div key={act.id} className="act-row">
              ...
              {/* GROUP SCHEDULE: overlapping friend circles */}
              {activeTab === "group" && (
      ...
      <NavBar active="schedule" onGroupClick={onGroupClick} onMenuClick={onMenuClick} />
    </div>
  );
}
